...
public class Feature_jan {
  ...
  // Term Distribution over feedback documents
  ...
  //Term Distribution for corpus level
  ...
  public static long CorpusLength(IndexReader index, LuceneQLSearcher seracher) throws IOException {
...
// Co-occurance with single query term over feedback documents
  public Map<String, Double> feature3(IndexReader index,List<String> expansionTermList, List<SearchResult> ser, List<String> qterms, int numfb) throws IOException {
    ...
    // Co-occurance with single query term over corpus level
...
// functions returns map of document id and corresponding positions
  ...
  // gives the query document position map
  ...
  //Co-occurance of paired query terms over feedback documents
  ...
  // triplet formation of pair term and the expansion term
  ...
  // weighted term proximity over feedback documents
  public Map<String,Double> feature7(IndexReader index, List<String> expansionTermList, List<String> terms,List<SearchResult> ser) throws IOException {
    ...
    // weighted term proximity over corpus level
...
//Document frequency for query terms and the expansion term together over the feedback document
  public Map<String,Double> feature9(IndexReader index,List<SearchResult> ser,List<String> qterms,List<String> expansionTermList) throws IOException {
    ...
    //Document frequency for query terms and the expansion term together over the corpus level
