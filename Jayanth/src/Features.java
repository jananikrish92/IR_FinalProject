...
public class Features {
    public static Map<String, Double> term_distrib(IndexReader index,
        ...
        FileDocLengthReader flen = new FileDocLengthReader(new File("index_trec123"), "content");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String pathIndex = "index_trec123";//"index_robust04";
        Analyzer analyzer = LuceneUtils.getAnalyzer(LuceneUtils.Stemming.Krovetz);

        String pathQueries = "queries_trec1-3";// "queries_robust04"// change it to your
        // query file path
       ...
       // String outputFolder = "indexTrec1230P\\BaselineRM3";//"C:\\Users\\jannu bhai\\IdeaProjects\\IRProjectVersion2\\indexTrec123OP\\BaseLineRM1"; //change based on setting
        ...
        double mu = 1000;
        int numfbdocs = 20;
        long gcount = 0, bcount = 0, ncount = 0, totalwcount = 0;
        for (String qid : queries.keySet()) {
           ...
           // PrintWriter pw = new PrintWriter(file);
            ...
            //Map<String, Double> scoresRM3 = searcher.estimateQueryModelRM3(terms,
                //    scoresRM1, 0.5);
            ...
            // System.out.println(qid);
            List<SearchResult> qlRes = searcher.search("content", terms, 1500.0, 1000);
            //System.out.println(qid);
            List<String> expansionTermsList =  new ArrayList<>(scoresSMM.keySet());//getCorrectedExpandedTerms(scoresSMM, qlRes, searcher);
            System.out.println(expansionTermsList.size());

            totalwcount += expansionTermsList.size();
...
*/
            ...
            System.out.println(qid+" good words : "+gcount+" bad words : "+bcount+" neutral words : "+ ncount+" total words : "+ totalwcount);
            //pw.close();
        }
        System.out.println("Baseline : RM1 Index : trec_123 ");
        System.out.println(" good words : "+gcount+" bad words : "+bcount+" neutral words : "+ ncount+" total words : "+ totalwcount);
    /*
