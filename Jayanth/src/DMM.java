/**
 * Created by jananikrishna on 12/19/16.
 */
...
import java.util.*;
    ...
    public class DMM {
        ...
        public Map<String, Double> estimateDMM(String field, List<String> terms,
            ...
            LuceneQLSearcher searcher = new LuceneQLSearcher("/Users/jananikrishna/Documents/IRFinalProject/index_wt10g");
